      ...
      >
        ...
        <div
          style={{
            ...
            height: "600px",
            background:
              "radial-gradient(circle, rgba(142,185,250,0.15) 0%, rgba(30,30,30,0) 70%)",
            borderRadius: "50%",
            zIndex: 0,
            pointerEvents: "none",
          }}
        ...
        >
          ...
          >
            Your Website Is Losing You Bids{" "}
      ...
      >
        <div className="container">
          ...
          >
            ...
            >
              <ShieldCheck size={20} color="var(--industrial-orange)" /> 16
              Years in Manufacturing
            </div>
            <div
              style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}
            >
              <MapPin size={20} color="var(--industrial-orange)" /> RGV & Texas
              Focused
            </div>
            <div
              style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}
            >
              <Code size={20} color="var(--industrial-orange)" /> No Custom Code
              Required
            </div>
            <div
              style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}
            >
              <DollarSign size={20} color="var(--industrial-orange)" />{" "}
              Fixed-Price Packages
            </div>
            <div
              style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}
            >
              <Clock size={20} color="var(--industrial-orange)" /> Results in 30
              Days
            </div>
          </div>
        </div>
      ...
      <section style={{ padding: "8rem 0" }}>
        <div className="container">
          ...
          <div className="bento-grid">
            {/* Large Feature Card */}
            <div
              className="bento-card bento-grid-wide"
              style={{
                display: "flex",
        ...
        <div className="container">
          ...
          >
            <h2 style={{ fontSize: "2.5rem", marginBottom: "1rem" }}>
              The Manufacturer's Digital Foundation
            </h2>
            <p
              style={{
                fontSize: "1.5rem",
