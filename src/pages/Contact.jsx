const Contact = () => {
  return (
    <section id="contact" className="contact-premium" style={{ background: "white" }}>
      <div className="container relative z-10 text-center" style={{ display: "flex", flexDirection: "column", alignItems: "center", margin: "0 auto" }}>
        <h2 className="cta-title reveal-anim visible" style={{ color: "black", textAlign: "center", fontFamily: "'Outfit', sans-serif", fontWeight: "900", fontSize: "clamp(2.75rem, 6vw, 4.5rem)" }}>
          Ready to Get Started?
        </h2>
        <p className="cta-subtitle reveal-anim visible" style={{ animationDelay: "0.1s", color: "black", textAlign: "center", fontSize: "1.125rem", fontWeight: "500", opacity: 0.9, marginBottom: "2.5rem", maxWidth: "800px", margin: "0 auto 2.5rem" }}>
