...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Master Plan Roadmap — consolidates all action items from
...
CONTENT = {
    ...
    "date":        "March 2026",
    "meta": "Master Plan Roadmap  ●  March 2026  ●  Prepared by Maker Web Studios",
...
def build(client, logo_path, output_dir):
    ...
    slug = client["slug"]
    out_path = os.path.join(output_dir, f"08_Master_Plan_Roadmap_{slug}.pdf")

    # ── Cover ─────────────────────────────────────────────────────────────────
    cover_fn = make_cover_template(
        doc_type_label = "MASTER PLAN ROADMAP",
        client_name    = None,
        logo_path      = logo_path,
        headline1      = "MASTER PLAN",
        headline2      = "ROADMAP",
    ...
    S.append(sp(4))
    S.append(Paragraph("Master Plan Roadmap", sH1))
    S.append(sp(4))
